...
This project focuses on analyzing a sales dataset to identify patterns, trends, distributions, and business insights using Python. 
---
...
Created visualizations using Matplotlib to better understand sales trends and distributions.
